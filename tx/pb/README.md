# GrapeOne Protobuff Transactions

Protobuff v3 mappings for Grape Transaction. Mostly used for transfering transactions, their serialization and creation/signing.

## Overview 
This package is a GO package and contains GO Transaction code generated from Protobuff mappings **by default** and can be imported in any Golang application to create/sign/transfer Grape Transactions already
...
The sample solution to create transaction, sign it, serialize to ProtoBuff, deserialize and verify its signature is given [here](createtx_test.go) in Golang. There we are using [grape1crypto](../grape1crypto/README.md) module (Golang) but there are other fully compatible crypto impls: [jscrypto](../grape1crypto/README.md) , [javacrypto](../javacrypto/README.md)
...
5. Sign serialized content using private key `grape1crypto.NewDSA().Sign(myPrivKey, unsignedBytes)`
