package io.aplfintech.grape.vm.tx;
 ...
 */
public class TxData {
    public static final byte MAIN_NET = 0;
    public static final byte TEST_NET = 1;
    public String senderPublicKeyHex = "897938b42aa41961ff960ea2aafedfe11dbe1628a73506322ffd3819e601bee5";//32 bytes
    public byte[] senderPublicKey = HexUtils.fromHex(senderPublicKeyHex);
    public String recipientHex = "168426fdc4c8a51b96b4bed827907b5fa6491ad0";//20 bytes
    public Address recipient = VmAddress.from(HexUtils.fromHex(recipientHex));
    public String signatureHex = "86534463d83a923e20558bfbf152480e92813443b84d7bb3e713a9e895d893e03fe608060405234801561001057600080fd5b50600436106100365760003560e";//64 bytes
    public byte[] signature = HexUtils.fromHex(signatureHex);
    public byte[] id = CryptoConfig.crypto().keccak256(signature);
    public static final List<Address> PREDEFINED_ADDRESSES = List.of(
    ...
    public static final List<byte[]> PREDEFINED_PRIVATE_KEYS = List.of(
