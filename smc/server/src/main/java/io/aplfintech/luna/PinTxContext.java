...
/**
 * Block context based on pinning tx from luna1 node
 */
@AllArgsConstructor
public class PinTxContext implements BlockContext {
    ...
    public Address coinbase() {
        return coinbaseAccount; // account supplied with transaction for execution (usually - statically defined on luna1 peer node)
    }
