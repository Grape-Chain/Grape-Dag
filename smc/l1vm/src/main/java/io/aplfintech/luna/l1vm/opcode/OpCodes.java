...
import io.aplfintech.luna.config.ConfigurationException;
...
import static io.aplfintech.luna.l1vm.opcode.Instructions.makeCallFunction;
import static io.aplfintech.luna.l1vm.opcode.Instructions.makeCreateFunction;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opAdd;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opAddMod;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opAddress;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opAnd;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opBalance;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opBaseFee;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opBeginSub;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opBlockHash;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opByte;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opCallDataCopy;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opCallDataLoad;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opCallDataSize;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opCallValue;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opCaller;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opChainId;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opCodeCopy;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opCodeSize;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opCoinBase;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opDifficulty;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opDiv;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opDup;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opEq;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opExp;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opExtCodeCopy;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opExtCodeHash;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opExtCodeSize;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opGas;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opGasLimit;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opGasPrice;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opGt;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opInvalid;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opIsZero;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opJump;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opJumpDest;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opJumpI;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opJumpSub;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opLog;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opLt;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opMLoad;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opMSize;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opMStore;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opMStore8;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opMod;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opMul;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opMulMod;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opNot;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opNumber;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opOr;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opOrigin;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opPc;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opPop;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opPush;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opPush0;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opReturn;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opReturnDataCopy;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opReturnDataSize;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opReturnSub;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opRevert;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSDiv;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSGt;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSLoad;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSLt;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSMod;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSStore;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSar;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSelfBalance;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSelfDestruct;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSha3;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opShl;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opShr;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSignExtend;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opStop;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSub;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opSwap;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opTLoad;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opTStore;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opTimestamp;
import static io.aplfintech.luna.l1vm.opcode.Instructions.opXor;
