...
class GrapechTest {
    ...
    void restoreAddress() {
        //GIVEN
        //WHEN
        var addr1 = Grapech.restoreAddress(publicKeyHex);
        //THEN
        assertThat(addr1)
            .isEqualTo(addressHex);
        //WHEN
        var addr2 = Grapech.restoreAddress(HexUtils.parseHex(publicKeyHex));
        //THEN
        assertThat(addr2)
    ...
    void testWalletJson() {
        ...
        //WHEN
        var genesisWallet = JsonUtils.HEX_MAPPER.readValue(walletJson, Grapech.Wallet.class);
        //THEN
    ...
    void createRandomWallet() {
        //GIVEN
        //WHEN
        var wallet1 = Grapech.createRandomWallet();
        var wallet2 = Grapech.createRandomWallet();
        //THEN
        assertThat(wallet1)
    ...
    void createWallet() {
        //GIVEN
        //WHEN
        var wallet = Grapech.createWallet(publicKeyHex);
        //THEN
        assertThat(wallet)
    ...
    void createWallet2() {
        //GIVEN
        //WHEN
        var wallet = Grapech.createWallet(privateKeyHex, publicKeyHex);
        //THEN
        assertThat(wallet)
            .hasNoNullFieldsOrProperties()
