...
```bash
./grapepeer -id <ID> -rendezvous <pubsub rendezvous name> -port <port> -bootstrap
...
...
```bash
./grapepeer -id <ID> -rendezvous <pubsub rendezvous name> -port <port> -bootstrap -bootstrap_nodes [Private] /ip4/198.51.100.10/udp/33331/quic/p2p/QmS1L76o6q2CVG2AAtRC2PgSS4jznQce7k5ZtZT2LMbq89
...
...
```bash
./grapepeer -id <ID> -rendezvous <pubsub rendezvous name> -port <port> -leader -bootstrap_nodes /ip4/198.51.100.10/udp/33331/quic/p2p/QmS1L76o6q2CVG2AAtRC2PgSS4jznQce7k5ZtZT2LMbq89,/ip4/198.51.100.20/udp/33331/quic/p2p/QmV9si1eabw3sdHHnHJZKgtJVQiv7T5dE57Q1Q3syZzzwj
```
...
## Launch a full node
```
./grapepeer -id <ID> -rendezvous <pubsub rendezvous name> -port <port> -bootstrap_nodes /ip4/198.51.100.10/udp/33331/quic/p2p/QmS1L76o6q2CVG2AAtRC2PgSS4jznQce7k5ZtZT2LMbq89,/ip4/198.51.100.20/udp/33331/quic/p2p/QmV9si1eabw3sdHHnHJZKgtJVQiv7T5dE57Q1Q3syZzzwj
```
...
```bash
./grapepeer -id ..... <all usual options> -home ...
```